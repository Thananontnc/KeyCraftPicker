...
const parts = [
    ...
    { name: 'Wuque Studio Morandi (10 pcs)', type: 'switch', price: 6.00, image: 'https://steed.sg/cdn/shop/files/WSMorandicopy.jpg?v=1740811820&width=2048', specs: { brand: 'Wuque Studio', switchType: 'Linear', pricePerUnit: 0.60, pinType: '5-pin', technology: 'Mechanical' } },
    ...
    { name: 'GMK Red Samurai', type: 'keycap', price: 120.00, image: 'https://i.imgur.com/BpMmFHw.png', specs: { material: 'ABS', layoutSupport: ['60%', '75%', 'TKL'] } },
